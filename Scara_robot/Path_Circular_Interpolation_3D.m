 ...
 if (strcmp(Trajectory_type,'S_curve'))
                ...
                for i = 1:length(t)
                    ...
                    elseif t(i) <= te
                        ...
                        q_x(i) = O_cir(1) + r*cos(th)*sin(th_1);
                        q_y(i) = O_cir(2) + r*sin(th)*sin(th_1);
                        q_z(i) = O_cir(3) + r*cos(th_1);                 
                        aa = q_x(i);
                        bb = q_y(i);
                        cc = q_z(i);
                     ...
                     [T_sub, Infor_sub] = Inverse_Kinematics(a,alpha,d,theta,0,aa,bb,cc,handles,opacity);
