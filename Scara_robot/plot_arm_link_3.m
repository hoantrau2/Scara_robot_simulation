...
a = R1*cos(th);
b = R1*sin(th);
surf(handles.axes1, [a;a]+x, [b;b]+y, [z*ones(1, size(th, 2)); (z+50)*ones(1, size(th, 2))], 'FaceColor',[0 0 0]/255, 'EdgeColor', 'none', 'FaceAlpha', opacity)
fill3(handles.axes1, a+x, b+y, z*ones(1, size(th, 2)),[0 0 0]/255, 'FaceAlpha', opacity);
fill3(handles.axes1, a+x, b+y, (z+50)*ones(1, size(th, 2)),[0 0 0]/255, 'FaceAlpha', opacity);
...
a = R1*cos(th);
b = R1*sin(th);
surf(handles.axes1, [a;a]+x, [b;b]+y, [(z-40)*ones(1, size(th, 2)); ones(1, size(th, 2))*(z-40+20)], 'FaceColor',[0 178 238]/255, 'EdgeColor', 'none', 'FaceAlpha', opacity)
...
fill3(handles.axes1, a+x, b+y, (z-40)*ones(1, size(th, 2)),[0 178 238]/255, 'FaceAlpha', opacity);
